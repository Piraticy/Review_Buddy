...
4. In Supabase Authentication settings, keep the Email provider enabled and turn email confirmation off if you want instant learner registration without verification.
5. In Supabase Auth settings, create the admin auth user for `admin@reviewbuddy.app` with password `admin`.
6. Redeploy the app.
